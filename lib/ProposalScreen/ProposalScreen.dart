...
class ProposalScreen extends StatefulWidget {
  static String tag = GlobalStringText.tagProposalScreen;

  @override
  _ProposalScreenState createState() {
    return new _ProposalScreenState();
  }
}
//-----------------------------------------------------------------------------------------//
...
//-----------------------------------------------------------------------------------------//
        appBar: new AppBar(
          title: Text(GlobalStringText.Home.toUpperCase(),style: TextStyle(
