...
//----------------------------------------------------------------------------------------------//
class ProposalScreenDetails extends StatefulWidget {
  static String tag = GlobalStringText.tagProposalScreenDetails;
  final String value1;
  final String value2;
  ProposalScreenDetails({Key key,this.value1, this.value2}) : super(key: key);
  @override
  ProposalScreenDetailsState createState() => new ProposalScreenDetailsState();
}
//----------------------------------------------------------------------------------------------//
class ProposalScreenDetailsState extends State<ProposalScreenDetails>
...
//----------------------------------------------------------------------------------------------//
  String ProposalDetailsurl ='http://192.168.0.200/anuj/ATMA/HomePageAdv.php';
  fetchProposalDetails() async {
    http.post(ProposalDetailsurl, body: {
      ...
      if(!data['Status']) {
        ...
        setState(() {
          var extractdata = json.decode(resultProposal.body);
